                            ...
                            PopUp.open(
                                {
                                    title: '未激活',
                                    type: 'warn',
                                    msg: `程序还未激活，最多只能添加 ${NotActivatedAllowed} 个会员`,
                                    buttons: ['关闭'],
                                },
                                function () {
                                    this.removePopUp();
    ...
    (mainAddMemberElement) => {
        ...
        (function () {
            ...
            saveButton.addEventListener('click', () => {
                if (
                    !getAppStatus() &&
                    getDB.members().size().value() >= NotActivatedAllowed
                ) {
                    PopUp.open(
                        {
                            title: '未激活',
